                    ...
                    <div class="main-slide-item">
                        ...
                        <div class="main-slide-box">
                            <div class="main-slide-content">
                                ...
                                <h2><a href="<?php echo esc_url( get_permalink($post->ID) );?>"><?php echo esc_attr($post->post_title);?></a></h2>
                                <p><?php echo wp_trim_words(get_the_excerpt($post->ID), 20);?></p>
                                <a href="<?php echo esc_url( get_permalink($post->ID) );?>" class="btn-link"><?php the_field('title_text_read_more','option');?></a>
                            </div>
                        </div>
                    </div>
                    <?php }
